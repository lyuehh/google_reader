...
## 浏览器的渲染原理简介
### by 陈皓
### at 2013-05-22 08:17:47
### original <http://coolshell.cn/articles/9666.html>

<p>看到这个标题大家一定会想到这篇神文《<a href="http://taligarsiel.com/Projects/howbrowserswork1.htm">How Browsers Work</a>》，这篇文章把浏览器的很多细节讲得很细，而且也被<a href="http://ux.sohu.com/topics/50972d9ae7de3e752e0081ff">翻译成了中文</a>。为什么我还想写一篇呢？因为两个原因，</p>
...
<h4>浏览器工作大流程</h4>
<p>废话少说，先来看个图：</p>
<p style="text-align:center"><img alt="" src="http://coolshell.cn//wp-content/uploads/2013/05/Render-Process.jpg" width="712" height="231"></p>
...
<p>上面这段HTML会解析成这样：</p>
<p style="text-align:center"><img alt="" src="http://coolshell.cn//wp-content/uploads/2013/05/DOM-Tree-01.jpg" width="456" height="300"></p>
<p>下面是另一个有SVG标签的情况。</p>
<p style="text-align:center"><img alt="" src="http://coolshell.cn//wp-content/uploads/2013/05/DOM-Tree-02.jpg" width="408" height="320"></p>
<h4>CSS解析</h4>
...
<p>于是DOM Tree是这个样子：</p>
<p><img alt="" src="http://coolshell.cn//wp-content/uploads/2013/05/DOM-Tree-Example.jpg" width="368" height="318"></p>
<p>然后我们的CSS文档是这样的：</p>
...
<p><img alt="" src="http://coolshell.cn//wp-content/uploads/2013/05/CSS-Rule-Tree-Example.jpg" width="397" height="238"></p>
...
<p><img alt="" src="http://coolshell.cn//wp-content/uploads/2013/05/CSS-Content-Tree-Example.jpg" width="405" height="318"></p>
...
<p style="text-align:center"><img alt="" src="http://coolshell.cn//wp-content/uploads/2013/05/Firefox-style-context-tree.png" width="328" height="366"></p>
...
<p style="text-align:center"><img alt="" src="http://coolshell.cn//wp-content/uploads/2013/05/Render-Process-Skipping.jpg" width="712" height="196"></p>
...
<p><center><iframe src="http://reader.googleusercontent.com/reader/embediframe?src=http://player.youku.com/player.php/sid/XMzI5MDg0OTA0/v.swf&amp;width=480&amp;height=400" width="480" height="400"></iframe></center>Reflow的成本比Repaint的成本高得多的多。DOM Tree里的每个结点都会有reflow方法，一个结点的reflow很有可能导致子结点，甚至父点以及同级结点的reflow。<strong>在一些高性能的电脑上也许还没什么，但是如果reflow发生在手机上，那么这个过程是非常痛苦和耗电的</strong>。</p>
...
<ul>
<li>Mozilla 的 Style System Overview：<a href="https://developer.mozilla.org/en-US/docs/Style_System_Overview">https://developer.mozilla.org/en-US/docs/Style_System_Overview</a></li>
</ul>
<ul>
