...
<span style="font-size:large">之前在学习python的时候，看过python的八荣八耻，之后发现python 神奇之处，import this
<br></span>
<br>
<br><pre name="code">
...
<br>
<br>
<br><span style="font-size:large">Don't reinvent the wheel</span>
<br>
<br><pre name="code">Before writing any code,
➔ ➔ ➔ ➔
...
Search the web. Google is your friend.</pre>
<br>
<br>
<br><span style="font-size:large">python 八荣八耻</span>
<br><pre name="code">以动手实践为荣 , 以只看不练为耻;  
以打印日志为荣 , 以单步跟踪为耻;  
以空格缩进为荣 , 以制表缩进为耻;  
以单元测试为荣 , 以人工测试为耻;  
