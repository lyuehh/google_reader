...
<p>To be able to consume the provider’s API you will need to change your applications a bit, first you will need to install authentasaurus and configure it to remotely authenticate from the provider.</p>
